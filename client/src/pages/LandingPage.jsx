    ...
    return (
      <div className="page-shell h-screen w-full flex flex-col items-center justify-center">
        <div className="relative flex items-center justify-center">
          <div className="absolute w-24 h-24 border-2 border-cyan-400/20 rounded-full animate-ping" />
          <div className="absolute w-16 h-16 border-t-2 border-cyan-300 rounded-full animate-spin" />
          <Shield className="text-cyan-300 animate-pulse" size={32} />
        </div>
        <p className="mt-8 text-cyan-300/60 font-mono text-xs tracking-[0.3em] uppercase">Establishing Secure Link...</p>
      </div>
    );
  }

  return (
    <div className="page-shell min-h-screen font-sans text-slate-200 overflow-x-hidden selection:bg-cyan-500/30">
      ...
      <div className="fixed inset-0 z-0 text-white">
        ...
        <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-violet-500/10 blur-[120px] rounded-full" />
        <div className="absolute inset-0 bg-[url('/noise.svg')] opacity-20 mix-blend-overlay" />
        <div className="absolute inset-0 hero-grid opacity-30" />
      </div>

      {/* Navigation */}
      <nav className="fixed top-0 w-full z-[100] border-b border-white/5 bg-[#050816]/80 backdrop-blur-xl px-6 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3 group cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <div className="bg-cyan-500 p-2 rounded-lg group-hover:rotate-12 transition-transform duration-300 shadow-[0_0_30px_rgba(0,229,255,0.2)]">
          ...
          <div className="hidden md:flex items-center space-x-8 text-sm font-medium text-slate-400">
            ...
            <button onClick={() => scrollToSection('network')} className="hover:text-cyan-300 transition-colors">Network</button>
            ...
            <Link to="/auth" className="bg-cyan-500 hover:bg-cyan-400 text-[#041019] px-6 py-2 rounded-full shadow-lg shadow-cyan-500/20 transition-all font-bold">
              Get Started
            </Link>
          </div>
        </div>
      ...
      <main className="relative z-10">
        ...
        <section className="pt-40 pb-20 px-6">
          <div className="max-w-7xl mx-auto text-center">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-400/20 text-cyan-300 text-xs font-bold mb-8"
            >
            ...
            >
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-violet-300 to-emerald-300">
                For Global Trade.
              </span>
            </motion.h1>
            ...
            >
              <Link to="/auth" className="flex items-center justify-center gap-2 bg-white text-[#050816] px-8 py-4 rounded-xl font-bold text-lg hover:bg-cyan-50 transition-all active:scale-95">
        ...
        <motion.section style={{ y: y1 }} className="px-6 pb-32">
          <div className="max-w-6xl mx-auto relative group">
            <div className="absolute -inset-1 bg-gradient-to-r from-cyan-500 to-violet-500 rounded-[2rem] blur opacity-25 group-hover:opacity-40 transition duration-1000"></div>
            <div className="relative bg-[#0B1224] border border-white/10 rounded-[2rem] overflow-hidden shadow-2xl">
              {/* Fake UI Header */}
              <div className="h-12 border-b border-white/5 bg-white/5 flex items-center px-6 gap-2">
                ...
                <div className="mx-auto bg-white/5 px-4 py-1 rounded text-[10px] text-slate-400 font-mono">
              ...
              <div className="aspect-video relative overflow-hidden bg-slate-900">
                ...
                <div className="absolute top-10 left-10 p-4 bg-slate-900/90 backdrop-blur-xl border border-white/10 rounded-xl w-64 shadow-2xl">
                  <div className="flex justify-between items-center mb-4">
                    <span className="text-[10px] font-bold text-cyan-300 uppercase tracking-widest">Active Fleet</span>
                ...
                <div className="absolute bottom-10 right-10 p-4 bg-violet-600/90 backdrop-blur-xl rounded-xl text-white shadow-2xl">
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
              <div className="max-w-2xl">
                <h2 className="text-cyan-300 font-mono text-sm tracking-widest uppercase mb-4">Core Infrastructure</h2>
            ...
            <div className="grid md:grid-cols-3 gap-px bg-white/5 border border-white/5 rounded-3xl overflow-hidden">
              {features.map((f, i) => (
                <div key={i} className="bg-[#020617] p-10 hover:bg-white/[0.02] transition-colors group">
                  <div className="mb-8 text-cyan-300 group-hover:scale-110 group-hover:text-cyan-200 transition-transform">
                    {f.icon}
                  </div>
              ...
              <div className="grid md:grid-cols-4 gap-8">
                {[
                  ...
                  <div key={i} className="text-center p-8 bg-white/5 border border-white/10 rounded-3xl">
                    <div className="text-[10px] font-black text-cyan-300 uppercase tracking-[0.2em] mb-4">{s.label}</div>
        ...
        <section className="py-40 px-6 text-center relative overflow-hidden">
          <div className="absolute inset-0 z-0">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-cyan-500/20 blur-[180px] rounded-full" />
          </div>
          <div className="relative z-10 max-w-4xl mx-auto">
            <h2 className="text-5xl md:text-7xl font-black text-white mb-10 tracking-tighter">Ready to optimize?</h2>
            <div className="flex flex-wrap justify-center gap-6">
              <Link to="/auth" className="px-12 py-5 bg-cyan-500 text-[#041019] rounded-2xl font-bold text-xl hover:bg-cyan-400 hover:shadow-2xl hover:shadow-cyan-500/40 transition-all">
                Access Platform
              </Link>
            </div>
